  ...
  return (
    <div className="w-full bg-white border relative  border-darkGreen scale-75 h-80 rounded-lg shadow dark:bg-darkGreen dark:border-darkGreen ">
      ...
      <div className="p-5 backdrop-blur-lg absolute bottom-0 right-0 z-20 h-auto w-full">
        ...
        <Link
          to={path}
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-light text-white bg-darkGreen rounded-lg hover:bg-lightGreen focus:ring-2 focus:outline-none focus:ring-darkGreen dark:bg-darkGreen dark:hover:bg-lightGreen dark:focus:ring-bg-lightGreen">
          See more
