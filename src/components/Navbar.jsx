...
const Navbar = () => {
  ...
  return (
    <div className=" fixed grid grid-cols-2 md:grid-cols-3 px-8 py-5 z-30  top-0 w-full  text-light drop-shadow-[0_5px_5px_rgba(0,0,0,0.15)]  ">
      <Link to="/" className="flex justify-center gap-2 font-bold text-xl tracking-widest items-center drop-shadow-3xl  text-darkGreen">
      ...
      <form
        ...
        className="flex  flex-row  justify-start   md:-my-2 rounded-3xl bg-light md:pe-8 hover:scale-x-110 hover:scale-y-105 max-w-md   pe-4 transition duration-3s00 ease-out md:col-start-2 md:col-end-3 col-span-2 h-4/6 my-auto drop-shadow-[0_5px_5px_rgba(0,0,0,0.75)] ">
